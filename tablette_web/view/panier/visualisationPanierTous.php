...
<table class='tableAffichage'>
	...
	<?php
		foreach($data['paniers'] as $panier){
			echo "\n\t\t<tr><td><img src='./images/plus.png' class='petitBoutonAjouter'><a href='./?r=panier/afficherParId&panier=".$panier->id."'>".$panier->client->nom." ".$panier->client->prenom."</a></td><td>".$panier->getNbOptions()."</td><td>".number_format($panier->getCoutTotal(), 0,'',' ')." €</td></tr>";
		}
		echo "\n\t";
	?>
</table>
