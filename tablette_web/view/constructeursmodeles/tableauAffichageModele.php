...
<table class="tableAffichage">
	...
	<?php
		foreach($data['joinTypeModeleOption'] as $joinTypeModeleOption){
			echo "<tr><td><img src='./images/loupe.png' class='petitBouton'><a href='./?r=option/visualiser&option=".$joinTypeModeleOption['option']->id."&retour=constructeursModeles/afficherModele-modele=".$_GET['modele']."'>".$joinTypeModeleOption['option']->libelle."</a><td>".number_format($joinTypeModeleOption['prix'], 0,'',' ')." €</td></tr>";
		}
	?>
</table>
